...
app.use("/api/kkprofiling", require("./routes/kkProfileRoutes")); // ✅ export route is already inside here
...
app.use("/api/kkprofile", require("./routes/kkProfileRoutes")); // ⚠️ duplicate, consider removing one
...
app.use(
  "/uploads/lgbtq_id_images",
  express.static(path.join(__dirname, "uploads/lgbtq_id_images"))
);
